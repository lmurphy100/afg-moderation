...
wandb.init(project="afg-safety-module")
weave.init('afg-safety-module')
...
results_df.to_csv("results_detoxify.csv", mode='w+',index=False)
# wandb.log({"results":wandb.Table(dataframe=results_df)})
wandb.log_artifact("./results_detoxify.csv", name='evaluation_results', type='dataset')
wandb.finish()
